...
public class Domain
{
    ...
    public static string DefaultSmtpHost = "postfix1.newsletterim.com";
    ...
    public static string DefaultFavicon = "favicon.ico";
    public static string DefaultProfilePostfixID = "0";
    public static string DefaultPsl = "";
    ...
    private string profilePostfixID;
    ...
    {
        get { return Postfix.getPostfixTestMachineBySite(int.Parse(DomainSiteID)).Password; }
        //get { return smtpPass; }
    ...
    {
        get { return Postfix.getPostfixTestMachineBySite(int.Parse(DomainSiteID)).UserName; }
    ...
    {
        get { return Postfix.getPostfixTestMachineBySite(int.Parse( DomainSiteID)).Host; }
        //get { return smtpHost; }
    ...
    {
        get { return favicon; }
        set { if (value != "") { favicon = value; } }
    }
   public string ProfilePostfixID
    {
        get { return profilePostfixID; }
        set { if (value != "") { profilePostfixID = value; } }
    }
    ...
    public static void LoadDomains()
    {
        using (MySqlConnection con = new MySqlConnection(Defaults.ConnStr))
        {
            ...
            string sql = "SELECT SiteDomainID,DomainMasterSite,DomainName,DomainName2,PanelUrl,WebsiteUrl,newsletterUrl,MultimediaUrl,CookieUrl,psl,CourseDomain,LandingUrl,EmailMX,EmailTestServer,EmailTestUser,EmailTestPass,supportMail, DefaultLang,TopLogo,TopLogo2,TextUnderLogo,TextUnderLogo2,LogoLink,BottomLogo,BottomLogo2,TextUnderBottomLogo,TextUnderBottomLogo2,LoginPanelBg,CharImage,BgImg,InnerLogo,InnerLogo2,FooterCredit,FooterCredit2,HideHomeFooter,loginTitle,loginTitle2,loginDescription,loginDescription2,innerTitle,innerTitle2,innerDescription,innerDescription2,loginHeading,loginHeading2,loginPopBg,expiredMessage,expiredMessage2,(SELECT Group_Concat(LangCode) FROM sitedomainsLangs WHERE sitedomainsLangs.SiteDomainID = sitedomains.SiteDomainID) AS TransLanguages ,favicon,profilePostfixID FROM sitedomains;";
            ...
            while (dr.Read())
            {
                if (!DomainArr.ContainsKey(dr["SiteDomainID"].ToString()))
                {
                    ...
                    TempDomainInfo.psl = dr["psl"].ToString();
                    ...
                    TempDomainInfo.Favicon = dr["favicon"].ToString();
                    TempDomainInfo.ProfilePostfixID = dr["profilePostfixID"].ToString();
    ...
    public static string getParamsByDomain(siteParamType paramType, int domainID)
    {
        ...
        var res = typeof(Domain).GetProperty(Defaults.UppercaseFirstLetter(paramType.ToString())).GetValue(DomainArr[domainID.ToString()], null);
        //using reflections to get the paraneter from the array entry (of type Domain):
        if (DomainArr.ContainsKey(domainID.ToString()) && res != null)
        {
            ...
            domainParameterValueFromReflection = (string)res;
        }
        else
        {
