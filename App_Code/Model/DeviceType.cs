...
public class DeviceType
{
    ...
    public static TypeDeviceView GetDeviceTypeByINT(int type)
    {

        TypeDeviceView TypeDevice = (TypeDeviceView)Enum.ToObject(typeof(TypeDeviceView), type);
        return TypeDevice;
    }
    ...
    public static TypeDeviceView GetDeviceType()
    {
        string ua = HttpContext.Current.Request.UserAgent;
        if (ua == null)
        {
            return default(TypeDeviceView);
        }
        TypeDeviceView ret = TypeDeviceView.Desktop;
