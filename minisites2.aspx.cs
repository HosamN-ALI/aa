...
public partial class Minisites2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (domainID != domainIDByUrl && siteID != 1000)
        {
            Response.Redirect("404.aspx");
        ...
        //if (MyReader.Read())
        //{
        ShowPageCredentials.Text = Defaults.GetPages(60, langCode);
        ...
        if (siteID != 0 && landingID != 0)
        {
            ...
            if (MyMinisiteRow != null)
            {
                if (Request.QueryString["lang"] == null)
                {
                    ...
                    sendFriendBody = "";
                    langDir = Defaults.GetPages(46, langCode, domainID);
                    ShowPageCredentials.Style["direction"] = langDir;
                ...
                if (Defaults.IsStatusActive(MyMinisiteRow.SiteStatus.ToString(), true))
                {
                    ...
                    LandingCanonical.Attributes["href"] = MyMinisiteRow.LandingCanonical.Replace("https://n.sendmsg.co.il", Defaults.NPath);
                    ...
                    int landingValidatorFromDB = 0;
                    {
                        ...
                        if (siteID != 0 && landingID != 0)
                        {
                            ...
                            msgContent = msgContent.Replace("id=\"showFacebook\">", "style=\"margin-left:10px; text-align:" + (langDir == "rtl" ? "right" : "left") + "; margin-right:10px; display:inline-block; text-align:" + (langDir == "rtl" ? "right" : " left") + "\"><a style=\"color:#919191;  text-decoration:none; font-weight:normal;font-size:14px; font-family:Arial; display:block; width:63; height:16px; text-align:" + (langDir == "rtl" ? "; right" : "; left") + "; vertical-align:middle; line-height:17px;  \" target=\"_blank\" href=\"https://www.facebook.com/sharer.php?u=" + Request.Url.Scheme + "://" + HttpUtility.UrlEncode(Defaults.NPath.Replace("https://", "") + "/Minisites2.aspx?p=" + landingID + "-" + ctrl.ToString() + "-" + siteID.ToString() + "&lang=" + langId) + "\"><img src=\"" + Defaults.SecureSitePath + "/images/facebook_Icon.png\" alt=\"\" style=\"vertical-align:middle; border:none; margin-left:3px;\" />" + ShareFacebook + "</a> ");
                            msgContent = msgContent.Replace("id=\"FacebookShare\"", "target=\"_blank\" href=\"https://www.facebook.com/sharer.php?u=" + Request.Url.Scheme + "://" + HttpUtility.UrlEncode(Defaults.NPath.Replace("https://", "") + "/Minisites2.aspx?p=" + landingID + "-" + ctrl.ToString() + "-" + siteID.ToString() + "&lang=" + langId) + "\"");
                            msgContent = msgContent.Replace("id=\"showForward\">", "style=\"display:inline-block;text-align:" + (langDir == "rtl" ? "right" : "left") + "margin-left:10px\"><a style=\"color:#919191; text-decoration:none; font-size:14px; font-family:Arial; display:inline-block; height:14px; vertical-align:middle; line-height:17px;  width:100px; margin-right:10px;\" href=\"mailto:?body=" + HttpUtility.UrlEncode(Defaults.NPath + "/Minisites2.aspx?p=" + landingID.ToString() + "-" + ctrl.ToString() + "-" + siteID.ToString() + "&lang=" + langId) + "\"><img src=\"" + Defaults.NPath + "/images/forward_Icon.png\" style=\"vertical-align:middle; border:none; margin-left:3px;\" />" + sendFriend + "</a>");
                            //msgContent = msgContent.Replace("id=\"showForward\">", "style=\"display:inline-block;text-align:right;margin-left:10px\"><a style=\"color:#919191; text-decoration:none; font-size:14px; font-family:Arial; display:inline-block; height:14px; vertical-align:middle; line-height:17px;  width:100px; margin-right:10px;\" href=\"" + HttpUtility.UrlEncode("mailto:?subject=FW:" + landingSubj + "&body=" + sendFriendBody + " " + "http://n.sendmsg.co.il/Minisites2.aspx?p=" + landingID.ToString() + "-" + ctrl.ToString() + "-" + siteID.ToString() + "&lang=" + langId) + "\"><img src=\"https://panel.sendmsg.co.il/images/forward_Icon.png\" style=\"vertical-align:middle; border:none; margin-left:3px;\" />" + sendFriend + "</a>");
                            ...
                            msgContent = Regex.Replace(msgContent, strRegex, "<div class=\"fb-like\" data-href=\"" + Request.Url.Scheme + "://" + Defaults.NPath.Replace("https://", "") + "/Minisites2.aspx?p=" + landingID + "-" + ctrl.ToString() + "-" + siteID.ToString() + "&lang=" + langId + "\" data-layout=\"standard\" data-action=\"like\" data-show-faces=\"true\" data-share=\"false\"></div>");
                        }
                    }
                }
                        ...
                        for (int i = 0; i < maxAdsPlaces; i++)
                        {
                            ...
                            if (showFlag)
                            {
                                ...
                                if (dr.Read())
                                {
                                    ...
                                    string hrefLink = Defaults.NPath + "/Minisites2.aspx?p=" + adLandingID + "-" + ((adSiteID + 3) * adLandingID * 36) + "-" + adSiteID;
            ...
            {
                msgContent = msgContent.Replace(".regPopUp()", ".regPopUp({domainID:'" + Domain.getDomainIDFromSiteID(siteID) + "',sid:'" + siteID + "'})");
            }
            #endregion
        }
        else
    ...
    {
        if (MyMinisiteRow.isPageLocked && (Session["barCodePage" + MyMinisiteRow.landingID.ToString()] == null ? true : (MyMinisiteRow.PageLocked.barCodePage != Session["barCodePage" + MyMinisiteRow.landingID.ToString()].ToString())))
        {
        ...
        if ((Request.QueryString["lang"] == null || Request.QueryString["lang"] == "1") && (MyMinisiteRow.landingLang == 1 || MyMinisiteRow.landingLangCode.ToLower() == "heb"))
        {
            ...
            if (AdInfoArr.Length == 6)
            {
                ...
                if (int.TryParse(AdInfoArr[0], out publisherSiteID) && int.TryParse(AdInfoArr[1], out adSiteID) && int.TryParse(AdInfoArr[2], out ContentAdID) && int.TryParse(AdInfoArr[3], out currentLandingID))
                {
                    if (System.Web.Security.FormsAuthentication.HashPasswordForStoringInConfigFile(((ContentAdID + adSiteID) * 14 - currentLandingID).ToString(), "md5") == AdInfoArr[4])
                    {
                        ...
                        pageView tempPageView = new pageView();
                        lock (PageViewsList)
                        {
