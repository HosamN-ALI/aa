<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="Minisites2.aspx.cs" Inherits="Minisites2" %>
            ...
            <table border="0" style="margin: auto; vertical-align: top; width: 100%;" cellpadding="0"
                ...
                <tr>
                    <td style="text-align: center;">
                        <table class="devider" style="margin: auto;" cellspacing="0" cellpadding="0" runat="server"
                            id="devider">
                            <%--devider table--%>
                            <tr>
                                <td id="defaultMain" runat="server" style="text-align: center; vertical-align: top; background-repeat: no-repeat; width: 100%;">
                                    <%--main--%>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; background: white;" id="BottomAdsHeight" runat="server">
                            <tr>
                                <td colspan="2">
                            ...
                            <tr runat="server" id="Copyright">
                                <td style="width: 100%; text-align: center; color: #1071b5; font-size: 13px; padding-top: 10px; padding-bottom: 20px;">
                                    <asp:Label runat="server" ID="ShowPageCredentials" Text='דף זה מוצג באמצעות שלח מסר – מערכת <a href="https://www.sendmsg.co.il" style="color:#1071b5">דיוור אלקטרוני</a>'></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
